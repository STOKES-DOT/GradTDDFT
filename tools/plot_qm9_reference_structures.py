#!/usr/bin/env python3
"""Render a QM9 reference CSV as a grid of molecular structures."""
...
from plot_qm9_val_bars_with_structures import (
...
def _plot_grid(rows: list[dict[str, str]], outdir: Path, xyzrender_src: Path, columns: int) -> dict[str, Any]:
    ...
    fig.suptitle("QM9 10-molecule set for the low-memory S1 run", fontsize=18)
    ...
    png_path = outdir / "qm9_10_molecule_structures_grid.png"
    pdf_path = outdir / "qm9_10_molecule_structures_grid.pdf"
    fig.savefig(png_path, bbox_inches="tight")
    fig.savefig(pdf_path, bbox_inches="tight")
    plt.close(fig)

    metadata_path = outdir / "qm9_10_molecule_structures.csv"
