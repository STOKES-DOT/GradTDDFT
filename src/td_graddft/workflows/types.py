...
class NeuralXCTrainingConfig:
    """Optimizer, network, and canonical molecular objective settings."""
    ...
    target_excitation_gaps_h: tuple[float, ...] | None = None
    seed: int = 0
    hidden_dims: tuple[int, ...] = DEFAULT_NETWORK_HIDDEN_DIMS
    network_architecture: Literal["graddft_residual"] = (
        DEFAULT_NETWORK_ARCHITECTURE
    )
