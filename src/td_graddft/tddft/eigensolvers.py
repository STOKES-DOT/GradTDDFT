...
def _all_roots_converged(
    residual_norms: Array,
    tol: Array,
    *,
    valid: Array | None = None,
) -> Array:
    converged = jnp.isfinite(residual_norms) & (residual_norms <= tol)
    ...
    *,
    ...
    def _step(
        ...
        def _do_iteration(iter_state):
            ...
            converged_now = _all_roots_converged(
                residual_norms,
                tol_arr,
...
def _davidson_lowest_tdhf(
    ...
    *,
    ...
    diag: Array,
    tol: float = PYSCF_TD_DAVIDSON_TOL,
    max_iter: int = FULL_TDDFT_DAVIDSON_MAX_CYCLE,
    max_subspace: int | None = None,
